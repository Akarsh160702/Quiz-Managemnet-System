...
public class EnhancedContactManagementSystem extends JFrame {
    ...
    public EnhancedContactManagementSystem() {
        setTitle("Enhanced Contact Management System");
        setSize(1000, 600);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new EnhancedContactManagementSystem().setVisible(true));
    }
}
